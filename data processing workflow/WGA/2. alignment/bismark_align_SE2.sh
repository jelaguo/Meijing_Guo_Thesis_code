...
bismark \
-phred33-quals -score_min L,0,-0.2 -bowtie2 \
--non_directional \
--rg_tag --rg_id $SAMPLE_NAME'2' --rg_sample $SAMPLE_NAME'2' \
--un \
--ambiguous \
-p 4 \
--output_dir /data/scratch/DBC/UBCN/CANCDYN/jguo/all-seq/01/SLX-23666/all/bismark/SE/nondirectional \
--genome /data/scratch/DBC/UBCN/CANCDYN/genomes/homo-sapiens/hg38/bisulphite-emseq \
-B $SAMPLE_NAME'2' \
$FIN_TRIM_DIR/$SAMPLE_NAME'.r_2.round3.fq.gz'
